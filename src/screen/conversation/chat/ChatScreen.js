...
const ChatScreen = ({navigation}) => {
  const {userTeacherToken, userTeacherData, receiveMessage, setReceiveMessage} =
    useChatContext();
  ...
  useEffect(() => {
    ...
    const valueFromIdType =
      userTeacherToken.type === 'user' ? 'Teacher' : 'User';
    const valueFromId =
      userTeacherToken.type === 'user' ? 'fromTeacherId' : 'fromUserId';
            ...
            ...chats,
            {
              ...
              userId:
                userTeacherToken.type === 'user'
                  ? userTeacherData.id
                  : receiveMessage.fromUserId,
              teacherId:
                userTeacherToken.type === 'teacher'
                  ? userTeacherData.id
                  : receiveMessage.fromTeacherId,
              [valueFromIdType]: {
